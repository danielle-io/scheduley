...
export const getCalendarColors = (themeColors, calIndex = 0) => {
    const colors = { calendars: [], ...themeColors };

    const mainColor = colors.calendars[calIndex] || themeColors.greyLight;
    const textColor =
        getLuminance(mainColor) < 0.5 ? colors.white : colors.black;

    colors.main = mainColor;
    colors.mid = darken(0.1, mainColor);
    colors.dark = darken(0.3, mainColor);
