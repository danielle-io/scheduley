...
describe("Utilities", () => {
    ...
    it("converts an object into a mapable array of key/value objects", () => {
        ...
        expect(utils.objectToArray({})).toEqual([]);
    });
    ...
    it("checks if an object is empty", () => {
        expect(utils.objectIsEmpty({})).toBe(true);
        expect(utils.objectIsEmpty({ thing: "something" })).toBe(false);
    });

    // capitalizeFirstLetter
    it("capitalizes the first letter of a string", () => {
        expect(utils.capitalizeFirstLetter("abcdefg")).toEqual("Abcdefg");
        expect(utils.capitalizeFirstLetter("abc defg")).toEqual("Abc defg");
    });

    // replaceUnderscores
    it("replaces underscores with spaces", () => {
        expect(utils.replaceUnderscores("abcdefg")).toEqual("abcdefg");
        expect(utils.replaceUnderscores("abc_defg")).toEqual("abc defg");
    });

    // turnSlugIntoString
    it("parses a snake-case slug into sentence case", () => {
        expect(utils.turnSlugIntoString("abc_defg")).toEqual("Abc defg");
    });
});
